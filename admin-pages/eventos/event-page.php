      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <?php
            if(isset($_GET['adm'])){
              echo'
              <a href="addevent.php?adm=S" class="btn btn-success col-2">
                <i class="nav-icon fa-solid fa-person-circle-plus"></i>&nbsp;&nbsp;
                     Criar Evento
              </a>';
            }else{
              echo'
              <a href="addevent.php?" class="btn btn-success col-2">
                <i class="nav-icon fa-solid fa-person-circle-plus"></i>&nbsp;&nbsp;
                     Criar Evento
              </a>';
            }
                    ...
                    if ($consulta->num_rows > 0){
                      if(isset($_GET['adm'])){
                        while(  $linha=$consulta->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <td>'.$linha['data'].'</td>
                          <td>'.$linha['hora'].'</td>
                          <td>'.$linha['qtd_ingressos'].'</td>
                          <td>'.$linha['atracao'].'</td>
                          <td>'.$linha['valor'].'</td>
                          <td>'.$linha['tipo_foto'].'</td>

                          <td>
                              <a href="altevent.php?id='.$linha['codeve'].'&adm=S" title="Alterar" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i></a>
                              <button title="Deletar" id="'.$linha['codeve'].'" class="btn btn-sm btn-danger" > <i class="fa fa-trash"></i></button>
                          </td>
                        </tr>';
                      }
                    }else{
                      while(  $linha=$consulta->fetch_array(MYSQLI_ASSOC)){
                        echo' <tr>
                         <td>'.$linha['codeve'].'</td>
                          ...
                          <td>'.$linha['tipo_foto'].'</td>
                        <td>
                            <a href="altevent.php?id='.$linha['codeve'].'" title="Alterar" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i></a>
                            <button title="Deletar" id="'.$linha['codeve'].'" class="btn btn-sm btn-danger" > <i class="fa fa-trash"></i></button>
                        </td>
                      </tr>';
                    }
